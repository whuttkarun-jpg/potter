...
export const DISCLAIMER_TEXT =
  'ข้อมูลเกณฑ์คะแนนและค่าน้ำหนักอ้างอิงตามประกาศทางการ TCAS69 รอบที่ 3 Admission (ปีการศึกษา 2569) ทั้งนี้ อาจมีบางสาขาวิชาตกหล่น ทางผู้จัดทำกราบขออภัยมา ณ ที่นี้ และโปรดตรวจสอบระเบียบการฉบับทางการกับทางมหาวิทยาลัยหรือ mytcas.com อีกครั้งก่อนการยื่นสมัคร';
